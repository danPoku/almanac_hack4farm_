...
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/Fetcher/CurlFetcher.php");
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/Exception.php");
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/WeatherForecast.php");
...
class OpenWeatherMap
{
    ...
    public function __construct($fetcher = null, $cacheClass = false, $seconds = 600)
    {
        ...
        if (!isset($fetcher)) {
            $fetcher = (function_exists('curl_version')) ? new OpenWeatherMap\Fetcher\CurlFetcher() : new FileGetContentsFetcher();
        }
        if ($seconds == 0) {
            $cacheClass = false;
        }

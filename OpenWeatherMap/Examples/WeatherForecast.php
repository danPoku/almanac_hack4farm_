...
//use almanac\OpenWeatherMap\Cmfcmf\OpenWeatherMap;
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap.php");
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/Util/City.php");
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/Util/Sun.php");
include ("C:/xampp/htdocs/webtech/almanac/OpenWeatherMap/Cmfcmf/OpenWeatherMap/Forecast.php");


use \OpenWeatherMap;


if (file_exists('C:/xampp/php/pear/PHPUnit/autoload.php')) {
    // Library is not part of a project. "composer install" was executed directly on this library's composer file.
    require('C:/xampp/php/pear/PHPUnit/autoload.php');
} else {
    // Library is part of a project.
    /** @noinspection PhpIncludeInspection */
    require('C:/xampp/php/pear/PHPUnit/autoload.php');	//edited by kgyinaye
}
...
$forecast = $owm->getWeatherForecast('Accra', $units, $lang, '50d6bd165896a4792af4e5fff4147d10', 10);
echo "EXAMPLE 1<hr />\n\n\n";
...
$forecast = $owm->getWeatherForecast('Accra', $units, $lang, '50d6bd165896a4792af4e5fff4147d10', 3);
echo "EXAMPLE 2<hr />\n\n\n";
